...
<li className=" linkAnimation "><Link href="/Bet10kto15k"><h1  className="text-3xl">10k To 15K</h1></Link></li>
<li className=' linkAnimation text-center ' ><Link  href="/Bet15kto20k"><h1 className="text-3xl">15k To 20k</h1></Link></li>
